...
enum Boss
{
    ...
    THE_WHISPERER("The Whisperer", "The ASMRtist"),
    WHISPERER("Whisperer", "ASMRtist"),
    ...
    THE_GAUNTLET("The Gauntlet", "The Glove"),
    ...
    THE_INFERNO("The Inferno", "The Sauna"),
    NEX("Nex", "Sex"),
    ...
    WINTERTODT("Wintertodt", "Windertodt"),
    ...
    CORRUPTED_GAUNTLET("Corrupted Gauntlet", "Corrupted Glove"),
