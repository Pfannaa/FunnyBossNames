...
enum Boss
{
    ...
    NEX("Nex", "Nex"),
    THE_NIGHTMARE("The Nightmare", "The Nightmare"),
    ...
    OLM("Great Olm", "Big O'"),
    OLMS_LEFT_HAND("Great Olm (Left claw)", "Big O's left fap hand"),
    OLMS_RIGHT_HAND("Great Olm (Right claw)", "Big O's right fap hand"),
